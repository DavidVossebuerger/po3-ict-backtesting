...
class MovingAverageCrossoverStrategy(Strategy):
    def __init__(self, params: dict):
        ...
        # Default to 96 H1 bars (~4 trading days) to suppress whipsaw
        # in ranging markets. Without this, 20/50 SMA on M30 EURUSD
        # produces 6000+ trades over 18 years, which bleeds the book on
        # spread+slippage alone.
        self._cooldown_bars = int(params.get("ma_cooldown_bars", 96))
